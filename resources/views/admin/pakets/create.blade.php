        ...
        <div class="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-slate-100">
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <input type="text" name="nama_paket" required placeholder="Contoh: Paket Bali 3D2N All Inclusive" class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-600 outline-none transition-colors text-sm">
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        <label class="block text-sm font-bold text-slate-700 mb-2">Destinasi <span class="text-red-500">*</span></label>
                        <input type="text" name="destinasi" required placeholder="Contoh: Bali" class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-600 outline-none transition-colors text-sm">
                    </div>
                    <div>
                        <label class="block text-sm font-bold text-slate-700 mb-2">Harga per orang (Rp) <span class="text-red-500">*</span></label>
                        <input type="number" name="harga" required placeholder="0" class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-600 outline-none transition-colors text-sm">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
                    <div>
                        ...
                        <input type="number" name="durasi" required value="3" class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-600 outline-none transition-colors text-sm">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="number" name="maks_peserta" value="20" class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-600 outline-none transition-colors text-sm">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-slate-100">
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <textarea name="deskripsi" required rows="3" placeholder="Tuliskan deskripsi singkat namun menarik tentang paket wisata ini..." class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-600 outline-none transition-colors text-sm"></textarea>
                </div>

                <div>
                    <label class="block text-sm font-bold text-slate-700 mb-2">Itinerary <span class="text-red-500">*</span></label>
                    <textarea name="itinerary" required rows="5" placeholder="Hari 1: ...&#10;Hari 2: ...&#10;Hari 3: ..." class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-600 outline-none transition-colors text-sm"></textarea>
        ...
        <div class="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-slate-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    <div class="border-2 border-dashed border-slate-300 rounded-xl bg-slate-50 p-8 flex flex-col items-center justify-center text-center hover:bg-slate-100 transition-colors cursor-pointer">
                        <i class="fas fa-upload text-2xl text-slate-400 mb-3"></i>
                        <p class="text-sm font-bold text-slate-700">Klik untuk unggah atau seret file</p>
